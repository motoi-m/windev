...
# ページ接続
driver.get("https://demo-matchingsystem.dev-salon.com/sitenew/work_edit/")
...
with open(filename, encoding="utf-8-sig", newline="") as f:
    ...
    for row in csvreader:
        ...
        # 新規登録ページの要素
        category1 = driver.find_element(By.ID, "work_edit_category_main")
        select = Select(category1)
        select.select_by_index(int(csv_cate1))

        category2 = driver.find_element(By.XPATH, '//*[@id="first_name-6"]')
